              ...
              <div className="card-body pt-0">                                    
                <form className="my-4" action="https://mannatthemes.com/rizz/default-dark/index.html">            
                  <div className="form-group mb-2">
                    ...
                    <input type="text" className="form-control" id="userEmail" name="Email" placeholder="Enter Email Address" />                               
                  </div>{/*end form-group*/}             
                  <div className="form-group mb-0 row">
                    <div className="col-12">
                      <div className="d-grid mt-3">
                        <button className="btn btn-primary" type="button">Reset <i className="fas fa-sign-in-alt ms-1" /></button>
                      </div>
                    </div>{/*end col*/} 
                  </div> {/*end form-group*/}                           
                </form>{/*end form*/}
